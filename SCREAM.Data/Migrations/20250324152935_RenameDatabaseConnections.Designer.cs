...
namespace SCREAM.Data.Migrations
{
    ...
    [Migration("20250324152935_RenameDatabaseConnections")]
    partial class RenameDatabaseConnections
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCREAM.Data.Entities.Backup.BackupJob", b =>
                {
                    ...
                    b.Property<bool>("HasTriggeredRestore")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SCREAM.Data.Entities.Backup.BackupPlan", b =>
                {
                    ...
                    b.Property<long>("DatabaseTargetId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SCREAM.Data.Entities.DatabaseTarget", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("DatabaseTargets", (string)null);
                });
            ...
            modelBuilder.Entity("SCREAM.Data.Entities.Restore.RestorePlan", b =>
                {
                    ...
                    b.Property<long>("SourceBackupPlanId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SCREAM.Data.Entities.Backup.BackupPlan", b =>
                {
                    b.HasOne("SCREAM.Data.Entities.DatabaseTarget", "DatabaseTarget")
                        .WithMany()
                        .HasForeignKey("DatabaseTargetId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SCREAM.Data.Entities.Restore.RestorePlan", b =>
                {
                    ...
                    b.HasOne("SCREAM.Data.Entities.Backup.BackupPlan", "SourceBackupPlan")
                        .WithMany()
                        .HasForeignKey("SourceBackupPlanId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("DatabaseTarget");

                    b.Navigation("SourceBackupPlan");
                });
